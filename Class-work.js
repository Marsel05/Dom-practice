...
// const task4 = document.querySelectorAll(".navlinkitem")
...
//     Task 6
// Вы пишете робота, который проверяет, что страница
// отображается корректно, по правилам внутри элемента
// с классом nav__link должен быть текст порядкового
// номера индекса. И у этого же элемента должен быть
...
// Ваша задача вернуть массив атрибутов data-link у элементов,
// у которых сломана логика. То есть текст внутри не имеет
// соответствующего класса.Используйте map для обхода массива.
// Иными словами элемент считается сломанным если в классах
// не содержится текста элемента.
...
// const board = document.querySelector("#append-div")
